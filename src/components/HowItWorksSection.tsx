        ...
        <div className="w-full max-w-5xl mx-auto">
          ...
          duration: 0.6
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              return <motion.div key={index} className="bg-card/30 border border-border hover:border-primary/50 rounded-lg p-6 transition-all duration-300 hover:shadow-[0_0_30px_rgba(255,102,0,0.15)]" initial={{
                opacity: 0,
                y: 30
              }} animate={inView ? {
                opacity: 1,
            ...
            <motion.div className="mt-12 text-center bg-secondary/10 border border-secondary/30 rounded-lg p-6" initial={{
            opacity: 0,
            scale: 0.95
          }} animate={inView ? {
            opacity: 1,
