...
const HeroSection = () => {
  ...
  return <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-cover bg-center opacity-70 hidden md:block" style={{
      backgroundImage: `url(${heroBackground})`
    }} />
      <div className="absolute inset-0 bg-cover bg-center opacity-70 md:hidden" style={{
